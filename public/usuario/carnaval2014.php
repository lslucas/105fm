                        ...
                        <div class="clear"></div>
                          ...
                          <form id="form1" name="form1" method="post" action="">
                            ...
                            <table width="483" border="0">
                              ...
                              <tr>
                                <input type='hidden' name='campo1_label' value='carnaval2014'/>
                                <td class="align_right">DESEJA CONCORRER A INGRESSOS PARA O CARNAVAL 2014?</td>
                                <td><input type="radio" name="campo1_value" id="campo1_value" value="1"<?=isset($_POST['campo1_value']) && $_POST['campo1_value']=='1' ? ' checked' : null?>/>
                                  <span class="alinha">Sim</span>
                                  <input type="radio" name="campo1_value" id="campo1_value" value="0"<?=isset($_POST['campo1_value']) && $_POST['campo1_value']=='0' ? ' checked' : null?>/>
                                  <span class="alinha">                                 Não</span></td>
                              </tr>
                              <tr>
                                <td>&nbsp;</td>
