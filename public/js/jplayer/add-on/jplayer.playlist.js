...
(function($, undefined) {
	...
	jPlayerPlaylist.prototype = {
		_cssSelector: { // static object, instanced in constructor
			...
			cssSelectorAncestor: ".jp-playlist"
		},
			...
			if(instant && !$.isFunction(instant)) {
				...
				$(this.cssSelector.playlist + " ul").slideUp(displayTime, function() {
					...
					$.each(self.playlist, function(i,v) {
						...
						// $($this).find('.smallartist-thumb').maskable({ maskSrc: 'images/radio/capaDisco.png' });
					});
		...
		_createListItem: function(media) {
			...
			var listItem = "";
			liClass = (media.i%2) ? 'musica1' : '';
			listItem += "<li class='"+liClass+"'>\n";
			listItem += "\t<div id='thumbMusica'>\n";
			listItem += "\t\t<a href='javascript:void(0);' class='" + this.options.playlistOptions.itemClass + "' tabindex='1'>\n";
			// listItem += "\t\t\t<img src='public/images/radio/capaDisco.jpg' style='background:url(\""+media.thumb+"\") top left no-repeat;' width=60 height=60 border=0>\n";
			// listItem += "\t\t\t<img src='"+media.thumb+"' class='smallartist-thumb' width=60 height=60 border=0>\n";
			listItem += "\t\t\t<img src='images/radio/capaDisco.png' style='background-image: url("+media.thumb+"); background-position: 50% 50%; background-repeat: no-repeat no-repeat; ' width=60 height=60 border=0>\n";
			listItem += "\t\t</a>\n";
			listItem += "\t</div>\n";
			listItem += "\t<p>\n";
			listItem += "<a href='javascript:void(0);' class='" + this.options.playlistOptions.itemClass + "' tabindex='1'>" + media.title + (media.artist ? " <br/><span class='jp-artist'>" + media.artist + "</span>" : "") + "</a>";
			...
			$('.jp-playlist').mCustomScrollbar('update');
		...
		_highlight: function(index) {
			if(this.playlist.length && index !== undefined) {
				...
				$(this.cssSelector.title + " li").html(this.playlist[index].title + (this.playlist[index].artist ? " <span class='jp-artist'>por " + this.playlist[index].artist + "</span>" : ""));
			}
		},
		...
		play: function(index) {
			...
			var listVar = this.playlist[index];
			var headerMusic = '';
			...
			$('<img/>').attr('src', listVar.thumb).load(function(){
				$('.txtTitulo').hide().html(headerMusic).fadeIn();
			});
