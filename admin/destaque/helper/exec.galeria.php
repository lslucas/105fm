<?php
	...
	if (isset($_FILES)) {
	  ...
	  include_once "_inc/class.upload.php";
	   ...
	   $sql_smod = "SELECT rdg_pos FROM ".TABLE_PREFIX."_r_${var['table']}_galeria WHERE rdg_${var['pre']}_id=? ORDER BY rdg_pos DESC LIMIT 1";
	   ...
	   $pos = ($pos!==0)?$pos=$pos+1:$pos;
	       ...
	       $sql= "INSERT INTO ".TABLE_PREFIX."_r_${var['table']}_galeria (rdg_${var['pre']}_id, rdg_imagem, rdg_pos) VALUES (?, ?, ?)";
