...
<div align=left>
		<form name='search' action='<?=$_SERVER['PHP_SELF']?>' method='get' class='form form-horizontal'>
			...
			<input type='text' name='q' class='input-large' placeholder='Album' value='<?=isset($_GET['q']) ? $_GET['q'] : null?>'>
...
$delete_images = null;
$delete_images = "&prefix=r_${var['pre']}_galeria&pre=rfg&col=imagem&folder=${var['imagem_folderlist']}";
