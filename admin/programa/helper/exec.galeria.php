<?php
    ...
    if (isset($_FILES)) {
      ...
      include_once "_inc/class.upload.php";
       ...
       $sql_smod = "SELECT rsg_pos FROM ".TABLE_PREFIX."_r_${var['table']}_galeria WHERE rsg_${var['pre']}_id=? ORDER BY rsg_pos DESC LIMIT 1";
       ...
       $pos = ($pos!==0)?$pos=$pos+1:$pos;
           ...
           $sql= "INSERT INTO ".TABLE_PREFIX."_r_${var['table']}_galeria (rsg_${var['pre']}_id, rsg_imagem, rsg_legenda, rsg_pos) VALUES (?, ?, ?, ?)";
