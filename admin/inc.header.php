	...
	<div class="navbar no-print">
		<div class="navbar-inner">
		  <div class="container">
			...
			<a class="brand" href="<?=$rp?>index.php"><!--<span id='brand-spacer'></span>--><?=SITE_NAME?></a>
			  ...
			  <ul class="nav pull-right">
				...
				<li class="dropdown">
				  ...
				  <ul class="dropdown-menu">
					<li><a href='<?=$rp?>index.php?p=<?=$user_p_update?>&update' class='tip'>Atualizar Perfil</a></li>
					<li><a href='<?=$rp?>index.php?p=<?=$user_p_update?>&alterasenha' class='tip'>Trocar Senha</a></li>
					<li class="divider"></li>
					<li><a href="<?=$rp?>logout.php"><i class='icon-off'></i> Logout</a></li>
				  </ul>
				</li>
				<?php
