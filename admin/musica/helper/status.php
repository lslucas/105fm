<?php
 ...
 // $col = 'status';
 // $col = isset($_GET['status']) ? 'status' : (isset($_GET['principal']) ? 'principal' :  (isset($_GET['contactado']) ? 'contactado' :  null));
 $col = isset($_GET['status']) ? 'status' : (isset($_GET['principal']) ? 'principal' : null);
