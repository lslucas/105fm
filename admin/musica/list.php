...
<table class="table table-condensed table-striped">
   <thead>
      <tr>
        ...
        <th width="60px" title='Música Principal' class='tip'>Principal?</th>
      </tr>
   </thead>
   <tbody>
<?php
...
?>
	...
	<tr id="tr<?=$id?>">
		...
		<td align=center>
			<a href="?p=<?=$p?>&principal&item=<?=$id?>&noVisual" class='tip principal principal<?=$id?>' title='Clique para alterar para música principal ou não principal' id='<?=$id?>' name='<?=$titulo?>'><?=$principal==1?'Sim':'Não'?></a>
		</td>
	</tr>
<?php
     $j++;
