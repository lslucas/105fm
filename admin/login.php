		  ...
		  <fieldset>
			...
			<div class="control-group">
			  ...
			  <div class="controls">
				<div class="input-prepend">
	                <span class="add-on"><i class='icon-user'></i></span><input type="text" class="input-xlarge email required" placeholder='email@host.com' name='username' id='username'>
				</div>
			  </div>
			</div>
			...
			<div class="control-group">
			  ...
			  <div class="controls">
				...
				<div class="input-prepend">
	                <span class="add-on"><i class='icon-lock'></i></span><input type="password" class="input-xlarge required" placeholder='******' name='password' id='password'>
				</div>
			...
			<div class='form-actions'>
				...
				<a href='esqueci-senha.php' value='Esqueci a Senha' class='btn'>Esqueci a Senha</a>
			</div>
