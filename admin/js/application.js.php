...
/**
 * Suporte a telefones de SP
 */
 /*
$('.phone').keyup(function(){

    if($(this).hasClass('phone_sp'))
        return;
    ...
    if(cel=='11') {
        $(this).removeClass('phoneX')
        				.addClass('phone_spX')
        				.unmask()
        				.mask("(99) 99999-9999", [], "(11) ");
...
$(function(){
	...
	************************************/
	...
	if ($('textarea.tinymce_simple') && typeof $().tinymce == 'function')
		$('textarea.tinymce_simple').tinymce({ <?=$TinyMCESimple?> });
