...
## RESGATA VARIAVEIS
	...
	$var['imagemWidth_texto']  = null;
	$var['imagemHeight_texto']  = null;
	// $var['imagemWidth_texto'] = ' Topo '.$var['topoWidth'].'px (largura)';
	...
	$var['imagem_folderlist'] = $var['path_imagem'].','.$var['path_original'];
