      ...
      if(count($row)>0) {
           ...
           // }
            ...
            foreach ($row as $id=>$arr) {
              // continue;
                echo "<tr style='border:1px solid #EEE;'>";
                $arquivo = empty($arr['arquivo']) || !file_exists('../../../storage/promocao/'.$arr['arquivo']) ? 'sem arquivo' : "<a href='http://radio105fm.com.br/storage/promocao/{$arr['arquivo']}' target='_blank'><img src='http://radio105fm.com.br/storage/promocao/{$arr['arquivo']}' width=200 border='0'/></a>";
