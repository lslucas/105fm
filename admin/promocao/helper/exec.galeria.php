<?php
    ...
    if (isset($_FILES)) {
      ...
      include_once "_inc/class.upload.php";
       ...
       $sql_smod = "SELECT rpg_pos FROM ".TABLE_PREFIX."_r_${var['table']}_galeria WHERE rpg_${var['pre']}_id=? ORDER BY rpg_pos DESC LIMIT 1";
       ...
       $pos = ($pos!==0)?$pos=$pos+1:$pos;
           ...
           $sql= "INSERT INTO ".TABLE_PREFIX."_r_${var['table']}_galeria (rpg_${var['pre']}_id, rpg_imagem, rpg_legenda, rpg_pos) VALUES (?, ?, ?, ?)";
