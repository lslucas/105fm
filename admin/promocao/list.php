...
<table class="table table-condensed table-striped">
   <thead>
      <tr>
        <th width="60px">Data Início</th>
        <th width="60px">Data Término</th>
        <th>Título</th>
        <th width="60px">Dt. Cadastro</th>
      </tr>
   </thead>
   <tbody>
<?php
...
$row_actions = <<<end
		<div class="btn-group">
          ...
          <ul class="dropdown-menu">
            <li><a href="{$rp}promocao/helper/exec.xls.php?item=$id" target='_blank' class='tip' title='Clique para exportar participantes'><i class="icon-file"></i> Exportar Participantes</a></li>
...
?>
	...
	<tr id="tr<?=$id?>">
		...
		<?php
		echo $titulo;
                      echo "<blockquote>$linhafina</blockquote>";
		echo $row_actions;
		?>
		</td>
		<td>
