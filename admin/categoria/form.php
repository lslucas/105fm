...
<p class='header'>All the fields with <b>- * -</b> are required.</p>
...
*/ ?>
    ...
    <div class="control-group">
      ...
      <div class="controls">
        <input type="text" class="input-xlarge required" placeholder='Title' name='titulo' id='titulo' value='<?=$val['titulo']?>'>
      </div>
    </div>
...
?>
    ...
    <div class='form-actions'>
		...
		<input type='button' id='form-back' value='back' class='btn'>
	</div>
